...
function createNewCard() {
    ...
    // Create the inner elements: card-down and card-up
    ...
    // Append card-down and card-up to the card element
...
function onCardFlipped(newlyFlippedCard) {
  ...
  incrementCounter('flips-counter', document.getElementById('flip-count'));
